...
<!--fin du menu-->
		<div class="container body">
			...
			<br /><br />
				...
				<div class="col-md-3"><img class="portrait" alt="ayad" src="../images/jug.jpg" ></div>				
				<div class="col-md-9">
				<p class="biblio">Originaire d’Afrique du nord, je vis à Paris, je suis
				...
				<div class="row">
                    ...
                    <div class="col-md-9">
                        <p class="biblio">Est un jeune et talentueux informaticien rencontré lors de 
				...
				<div class="row">
                    ...
                    <div class="col-md-3">
                        <img alt="Samir" src="../images/" class="portrait" >
                    </div>
                    <div class="col-md-9">
                        <p class="biblio">Est le fondateur de la start-up Legal Solution. 
				...
				<div class="row">
                    ...
                    <div class="col-md-3">
                        <img alt="Idir" src="../images/" class="portrait" >
                    </div>
                    <div class="col-md-9">
                        <p class="biblio">Jeune étudiant en design industriel, créatif et imaginatif, 
