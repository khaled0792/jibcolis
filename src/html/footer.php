    ...
    <div class="container-fluid" id="base_footer">
        ...
        <div class="element">
                ...
                <p>
                    ...
                    <a href="http://association-addra.com" target="_blank">ADDRA</a><br />
                    <a href="#">PRESSE</a><br />
                </p>
        </div>
        ...
        <div class="element">
            <div id="carre_droite">
                <div class="rs">
                    <a href="https://www.facebook.com/JibColis-Transport-COLIS-Entre-Particuliers-678877142284317/" class="fa fa2 fa-facebook" target = "_blank"></a>
                ...
                <div class="mail">
                    <form method="" action="">
                        <nobr><input type="mail" class="newsletter" name="mail" placeholder="NEWSLETTER" />
