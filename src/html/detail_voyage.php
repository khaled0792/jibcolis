    ...
    <div class="container body">
      ...
      <div id="conteneur">
          ...
          <div class="element">
              ...
              $req = $bdd->prepare('SELECT * FROM trajet where id = :id_colis');
              ...
              <table>
                  ...
                  <tr>
                      <td>Type de transport </td><td><?php echo $resultat['nature']; ?></td>
                  </tr>
                  <tr>
          ...
          if(isset($_POST['envoi_message'])) {
            ...
            echo "<script type='text/javascript'>document.location.replace('list_voyageurs.php');</script>";
          }
          }
          ?>
          <?php
